...
Project Planning and Structure: The HTML structure is well-organized, making use of semantic tags like <main>, <article>, <footer> and <div>. The code shows a clear separation between the main content and the attribution section, enhancing code readability and maintainability.
...
In this project I learned how to select elements with Javascript and manipulate them through the events and add text to existing elements from a result.

I used the technique of hiding the second card with the "d-none" class and then switched that class with the first card.

For this project I decided to use radio inputs for ratings to try to make it more responsive.
